...
use super::preclude::*;
use curtis_core::models::{Order, OrderBook, SpotTable, Trade, TradeDirection};

const TABLE_WIDTH: u16 = 18;

pub(crate) fn render(data: Arc<RwLock<SpotTable>>) -> Result<(), failure::Error> {
...
fn draw_time_info<B>(f: &mut Frame<B>, area: Rect, table: &SpotTable)
where
    B: Backend,
{
